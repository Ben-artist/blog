...
可见确实可行。抛开这里面仍有的漏洞不谈（下文会讲），HTTPS的加密却没使用这种方案，为什么？**最主要的原因是非对称加密算法非常耗时**，特别是加密解密一些较大数据的时候有些力不从心。而**对称加密快很多**。那我们能不能运用非对称加密的特性解决前面提到的对称加密的问题？
...
![HTTPS工作原理](../assets/images/https/https_work.png)
